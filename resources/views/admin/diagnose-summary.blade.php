...
@section('content')
    <main class="content">
        <div class="container-fluid p-1">
            <h1 class="h3 mb-3">Dashboard - Diagnose Summary</h1>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 d-flex justify-content-end">
                            ...
                            @if (isset($patient->id))
                            <a href="{{ route('admin.diagnose.patient.update',$patient->id) }}" class="btn btn-success p-2">
...
@section('scripts')
    <script src="{{ asset('backoffice/js/daignose-summary.js') }}"></script>
@endsection